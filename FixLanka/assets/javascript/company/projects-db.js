        ...
        if (Array.isArray(result.data) && result.data.length > 0) {
            ...
            phases.forEach((item, index) => {
                ...
                if (item.status === 'pending') {
                    actionBtn = `<button onclick="startPhase(${item.milestone_id || item.id})" class="btn-primary-small" style="padding: 6px 14px; font-size: 12px; font-weight: 600; background-color: #3b82f6; color: white; border: none; border-radius: 6px; cursor: pointer; display: inline-flex; align-items: center; gap: 6px; box-shadow: 0 2px 4px rgba(59, 130, 246, 0.2); transition: all 0.2s ease;" onmouseover="this.style.backgroundColor='#2563eb'; this.style.transform='translateY(-1px)'; this.style.boxShadow='0 4px 6px rgba(59, 130, 246, 0.3)';" onmouseout="this.style.backgroundColor='#3b82f6'; this.style.transform='translateY(0)'; this.style.boxShadow='0 2px 4px rgba(59, 130, 246, 0.2)';"><i class="fas fa-play" style="font-size: 10px;"></i> Start</button>`;
                } else if (item.status === 'in_progress') {
                    actionBtn = `<button onclick="openProofModal(${item.milestone_id || item.id})" class="btn-success-small" style="padding: 6px 14px; font-size: 12px; font-weight: 600; background-color: #10b981; color: white; border: none; border-radius: 6px; cursor: pointer; display: inline-flex; align-items: center; gap: 6px; box-shadow: 0 2px 4px rgba(16, 185, 129, 0.2); transition: all 0.2s ease;" onmouseover="this.style.backgroundColor='#059669'; this.style.transform='translateY(-1px)'; this.style.boxShadow='0 4px 6px rgba(16, 185, 129, 0.3)';" onmouseout="this.style.backgroundColor='#10b981'; this.style.transform='translateY(0)'; this.style.boxShadow='0 2px 4px rgba(16, 185, 129, 0.2)';"><i class="fas fa-check" style="font-size: 10px;"></i> Complete</button>`;
