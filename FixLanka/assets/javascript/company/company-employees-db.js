...
function updateStatisticsUI(data) {
    ...
    updateElement('.staff-card .stat-number', totals.total_employees || 0);
    updateElement('.staff-card .sub-stat:nth-child(1) .sub-number', totals.active_employees || 0);
...
function updateSpecialtyPreview(specialties) {
    ...
    specialties.forEach(spec => {
        ...
        item.innerHTML = `
            ...
            <span class="specialty-count">${spec.total_count || 0} Total, ${spec.active_count || 0} Active</span>
        `;
