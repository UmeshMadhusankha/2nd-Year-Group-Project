    ...
    <div class="modal-container">
        ...
        <div class="modal-body">
            <form id="quotation-form">
                ...
                <!-- Hidden fields for legacy support if needed -->
                <input type="hidden" id="estimated-duration" name="estimated_duration" value="0">
                <input type="hidden" id="estimated-start-date" name="estimated_start_date" value="<?php echo date('Y-m-d'); ?>">
                <input type="hidden" id="estimated-completion-date" name="estimated_completion_date" value="<?php echo date('Y-m-d'); ?>">
                ...
                <div class="form-section">
                    ...
                    <div class="pricing-subsection">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group-grid">
                                <label class="radio-card">
                                    <input type="radio" name="labor_pricing_method" value="hourly" checked>
                        ...
                        <!-- Labor Unit Pricing -->
                        <div id="labor-unit-pricing" class="unit-pricing-section">
                            <div class="form-row">
                                <div class="form-group col-12">
                                    <label class="form-label">
                                        Estimated Labor Cost (LKR) <span class="required">*</span>
                                        <span class="unit-label" id="labor-unit-label"></span>
                                    </label>
                                    <input type="number" id="labor-cost" name="labor_cost" class="form-input" 
                                        placeholder="Enter total labor cost or hourly rate" min="0" step="0.01" required>
                                    <input type="hidden" id="labor-unit-price" value="0">
                                    <input type="hidden" id="labor-quantity" value="1">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pricing-subsection">
                        ...
                        <div id="material-pricing-section" style="display: none;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio-group-grid">
                                    <label class="radio-card">
                                        <input type="radio" name="material_pricing_method" value="per_sqm" checked>
                                        <span class="radio-card-content">
                                            <i class="fas fa-ruler-combined"></i>
                                            <strong>Per m²</strong>
                                        </span>
                            ...
                            <div id="material-unit-pricing" class="unit-pricing-section">
                                <div class="form-group col-12">
                                    <label class="form-label">
                                        Estimated Material Cost (LKR) <span class="required">*</span>
                                        <span class="unit-label" id="material-unit-label"></span>
                                    </label>
                                    <input type="number" id="material-cost" name="material_cost" class="form-input" 
                                        placeholder="Enter total material cost or unit price" min="0" step="0.01" value="0">
                                    <input type="hidden" id="material-unit-price" value="0">
                                    <input type="hidden" id="material-quantity" value="1">
                                </div>
                            </div>
                        </div>
