...
?>
<link rel="stylesheet" href="<?= $basePath ?>/assets/css/admin & moderator/dashboard.css">
        ...
        <div class="bg-card rounded-lg border">
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <a href="<?= $basePath ?>/moderator/ads" class="nav-card bg-blue-500/10 border-blue-500/20 hover:bg-blue-500/20">
                    ...
                    <a href="<?= $basePath ?>/moderator/account-moderation" class="nav-card bg-red-500/10 border-red-500/20 hover:bg-red-500/20">
                        <div class="flex items-center space-x-3">
                    ...
                    <a href="<?= $basePath ?>/moderator/ad-reports" class="nav-card bg-green-500/10 border-green-500/20 hover:bg-green-500/20">
                        <div class="flex items-center space-x-3">
                    ...
                    <a href="<?= $basePath ?>/moderator/finance" class="nav-card bg-purple-500/10 border-purple-500/20 hover:bg-purple-500/20">
                        <div class="flex items-center space-x-3">
                    ...
                    <a href="<?= $basePath ?>/moderator/notifications" class="nav-card bg-orange-500/10 border-orange-500/20 hover:bg-orange-500/20">
                        <div class="flex items-center space-x-3">
                    ...
                    <a href="<?= $basePath ?>/moderator/static-content" class="nav-card bg-teal-500/10 border-teal-500/20 hover:bg-teal-500/20">
                        <div class="flex items-center space-x-3">
