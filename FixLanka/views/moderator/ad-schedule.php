...
?>
<link rel="stylesheet" href="<?= $basePath ?>/assets/css/admin & moderator/ad-schedule.css">
                                ...
                                <tr class="ad-row"
                                    ...
                                    <td>
                                        <div class="flex space-x-1">
                                            <?php if ($ad['status'] === 'Active'): ?>
                                                <button onclick="pauseAd(<?php echo $ad['id']; ?>)" class="btn btn-sm btn-secondary" title="Pause Ad">
                                                    <i data-lucide="pause" class="h-3 w-3"></i>
                                                </button>
                                            <?php elseif ($ad['status'] === 'Scheduled'): ?>
                                                <button onclick="activateAd(<?php echo $ad['id']; ?>)" class="btn btn-sm btn-primary" title="Activate Now">
                                                    <i data-lucide="play" class="h-3 w-3"></i>
                                                </button>
                                            <?php endif; ?>
                                            <button onclick="editSchedule(<?php echo $ad['id']; ?>)" class="btn btn-sm btn-secondary" title="Edit Schedule">
                    ...
                    <?php foreach ($scheduledAds as $ad): ?>
                        <div class="ad-schedule-card bg-muted/30 rounded-lg border p-6 hover:shadow-lg transition-all duration-200"
                            ...
                            <div class="flex space-x-2">
                                <?php if ($ad['status'] === 'Active'): ?>
                                    <button onclick="pauseAd(<?php echo $ad['id']; ?>)" class="flex-1 btn btn-sm btn-secondary">
                                        <i data-lucide="pause" class="mr-1 h-3 w-3"></i>
                                        Pause
                                    </button>
                                <?php elseif ($ad['status'] === 'Scheduled'): ?>
                                    <button onclick="activateAd(<?php echo $ad['id']; ?>)" class="flex-1 btn btn-sm btn-primary">
                                        <i data-lucide="play" class="mr-1 h-3 w-3"></i>
                                        Activate
                                    </button>
                                <?php endif; ?>
                                <button onclick="editSchedule(<?php echo $ad['id']; ?>)" class="btn btn-sm btn-secondary">
                                    <i data-lucide="edit" class="h-3 w-3"></i>
                                </button>
