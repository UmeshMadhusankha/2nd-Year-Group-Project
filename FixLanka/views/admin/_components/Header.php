...
function renderPageHeader($basePath, $title, $pageSubtitle = null, $currentPage = null, $searchPlaceholder = 'Search...')
{
    ...
    echo '<li class="profile-dropdown-item"><a href="/2nd-Year-Group-Project/FixLanka/admin-dashboard" class="profile-dropdown-link"><i class="fas fa-user"></i><span>My Profile</span></a></li>';
    echo '<li class="profile-dropdown-item"><a href="/2nd-Year-Group-Project/FixLanka/admin-dashboard" class="profile-dropdown-link"><i class="fas fa-cog"></i><span>Settings</span></a></li>';
