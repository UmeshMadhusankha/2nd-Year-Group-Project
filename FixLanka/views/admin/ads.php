            ...
            <div class="ads-table-header">
                ...
                <div class="ads-search-container">
                    <div class="ads-search-input">
                        ...
                        <input type="text" id="searchInput" placeholder="Search ads..." onkeyup="searchAds()">
                    </div>
...
<script>
    ...
    function renderAds(ads) {
        ...
        tbody.innerHTML = ads.map(ad => {
            ...
            return `
                <tr>
                    <td class="text-card-foreground font-medium">#${ad.id}</td>
                ...
                document.getElementById('adDetailsContent').innerHTML = `
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            ${ad.rejection_reason ? `
                                <div class="mt-4">
                                    <h4 class="font-medium mb-2 text-red-600">Rejection Reason</h4>
    ...
    async function confirmDelete() {
        ...
        try {
            const response = await fetch(`<?= $basePath ?>/api/ads/${deleteAdId}`, {
                method: 'DELETE'
            });
            ...
            if (response.ok && data.success) {
                ...
                showMessage(data.error || 'Failed to delete ad', 'error');
            }
        } catch (error) {
